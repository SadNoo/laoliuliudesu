...
| `raw_source_snapshots` | 不覆盖的范围内源响应、URL、SHA-256 和获取时间 |
| `draw_records` | 2026 第 048 期起规范化 6+1 开奖与逐期生肖锚点 |
...
- `draw_records.issue` 受数据库检查约束限制在 `2026048`～`2026999`。
