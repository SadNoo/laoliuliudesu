...
- 真实历史源：第 048 期边界切换后读取 181、插入 0、跳过 181；最新快照最早为
  `2026048`，没有第 001～047 期条目。
- 最新真实统计：第 `2026228` 期；前六名依次为蛇 10、猪 9、牛 8、马 8、羊 8、
  狗 6。有效样本 12，所有匹配期均不早于 `2026048`。
...
- 生产物理清理：删除第 001～047 期 47 条、快照条目 141 条和旧口径 AI 记录 6 条；
  清理及真实回填后开奖记录和快照早期条目均为 0。
...
- 历史分析：可查询 168 个历史期号，最早为 `2026051`；匿名访问接口返回 401。
